...
$dnsName    = "new-shyamalinfy-vm"  
$saName     = "shyamalinfyrgdisks509"
$location   = "southeastasia" 

$cred = Get-Credential -Message "Enter Admin Credentials"

# Resource group values
$rgName     = "shyamalinfy-rg" #this will contain new VMs

  
$rgVNETName = "shyamalinfy-rg"  #this is RG of following VNET
$VNETName   = "shyamalinfy-vnet"

# shyamal-VM2 specific variables 
$pubName    = "MicrosoftWindowsServer"
$offerName  = "WindowsServer"
$skuName    = "2012-R2-Datacenter"
$ipName     = "shyamalinfy-vm-ip-2" #NEW
$nicName    = "shyamalinfy-vm349-2" #NEW
$vmName     = "shyamal-VM2" #NEW
$vmSize     = "Standard_A1" #STANDARD_CAN_NOT_BE_CHANGED
$nsgName    = "shyamalinfy-vm-nsg" #OLD
$avSet      = "shyamalinfy-aset" #OLD
...
$skuName    = "Web"
$nicName    = "shyamal-sqlvmnic1" #NEW
$vmName     = "shyamal-sqlvm-1" #NEW
$vmSize     = "Standard_A1" #STANDARD_CAN_NOT_BE_CHANGED
